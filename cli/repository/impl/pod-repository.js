...
class PodRepository {
    ...
    updateContact(contact, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.login.myContact().then(cont => {
                ...
                return pod_util_1.PodUtil.readFile(urlContacts).then(res => {
                    if (res != null) {
                        return serializer_1.Serializer.serializeUpdateContact(contact, res).then(res2 => {
                            if (res2.trim() === '') {
                                throw new Error('error');
                            }
                            else {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (message.text != null && message.isMedia) {
                ...
                if (arrayName.length === 2 && arrayName[0].match(/[a-f]|[0-9]/g).length === arrayName[0].length) {
                    ...
                    pod_util_1.PodUtil.createFolder(urlFolder).then(res1 => {
                        pod_util_1.PodUtil.createFile(urlMedia, content).then(res2 => {
                            pod_util_1.PodUtil.giveGrantsTo(urlMedia, message.to.urlPod);
                            callback();
    ...
    deleteFileAttached(fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            const myContact = yield this.login.myContact();
            const urlMedia = myContact.urlPod + 'dechat/files/' + fileName;
            pod_util_1.PodUtil.removeFile(urlMedia);
        });
    }
    updateMessages(messages, contact) {
        return __awaiter(this, void 0, void 0, function* () {
            const urlMessage = yield this.getChatUrl(contact);
    ...
    addMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const urlFolder = (yield this.login.myContact()).urlPod + 'dechat';
            pod_util_1.PodUtil.createFolder(urlFolder).then(res1 => {
                pod_util_1.PodUtil.writeToFile(urlMessage, serializer_1.Serializer.serializeMessages(messages));
    ...
    auxAddNotification(notification, option) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    addNotificationDeletedMessage(notification) {
        return __awaiter(this, void 0, void 0, function* () {
