...
export declare class PodRepository implements Repository {
    ...
    addMediaMessage(content: any, message: Message, callback: any): Promise<void>;
    deleteFileAttached(fileName: string): Promise<void>;
    updateMessages(messages: Message[], contact: Contact): Promise<void>;
    ...
    auxAddNotification(notification: Notification, option: string): Promise<void>;
    addNotificationDeletedMessage(notification: Notification): Promise<void>;
