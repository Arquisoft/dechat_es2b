...
The source documents are located at
 https://github.com/Arquisoft/dechat_es2b/tree/master/src/docs[src/docs].
...
There are some simple Unit tests at:
 https://github.com/Arquisoft/dechat_es2b/tree/master/src/test[src/test].

There are also some
 https://cucumber.io/[Cucumber based tests]
 with a simple user story defined at:
 https://github.com/Arquisoft/dechat_es2b/tree/master/src/test/resources/features[src/test/resources/features].
...
The https://github.com/Arquisoft/dechat_es2b/tree/master/pom.xml[pom.xml] file
